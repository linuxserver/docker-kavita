...
* Shell access whilst the container is running: `docker exec -it kavita /bin/bash`
* To monitor the logs of the container in realtime: `docker logs -f kavita`
...
* Update all images: `docker-compose pull`
  * or update a single image: `docker-compose pull kavita`
* Let compose update all containers as necessary: `docker-compose up -d`
  * or update a single container: `docker-compose up -d kavita`
* You can also remove the old dangling images: `docker image prune`

### Via Docker Run

* Update the image: `docker pull lscr.io/linuxserver/kavita:latest`
* Stop the running container: `docker stop kavita`
* Delete the container: `docker rm kavita`
